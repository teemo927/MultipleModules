...
import com.kelvin.multiplemodules.zhihu.adapter.TopStoryPagerAdapter;
...
public class MainActivity extends AppCompatActivity
    ...
    public RecyclerView.Adapter getAdapter() {
        CommonAdapter adapter = new CommonAdapter<LatestNews.StoriesBean>(mContext, R.layout.adapter_main_zhihu, mDatas) {
            @Override
            protected void convert(ViewHolder holder, final LatestNews.StoriesBean storiesBean, int position) {
                ...
                if (storiesBean.getImages().size() >= 1 && img != null) {
