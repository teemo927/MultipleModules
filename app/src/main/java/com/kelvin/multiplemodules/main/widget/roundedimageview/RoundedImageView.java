...
package com.kelvin.multiplemodules.main.widget.roundedimageview;
...
public class RoundedImageView extends ImageView {
    ...
    /**
     * Set the corner radius of each corner individually. Currently only one unique nonzero value is
     * supported.
     *
