package com.kelvin.multiplemodules.main.widget;
...
public class BannerLoopAdapter extends PagerAdapter implements View.OnTouchListener, Runnable, ViewPager.OnPageChangeListener {
    ...
    public BannerLoopAdapter(final Context mContext, List<Integer> lists, ViewPager viewpager, LinearLayout mDots) {
    ...
    private void refreshData(List<Integer> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            root.setBackgroundResource(list.get(i));
            mViewList.add(root);
        }
